...
public class DoctorController {
	...
	public ResponseEntity<List<Doctor>> saveDoctors(@PathVariable("hospital_id") String hospital_id,
			@Valid @RequestBody List<Doctor> doctors) {
		return new ResponseEntity<List<Doctor>>(doctorService.saveDoctors(doctors, hospital_id), HttpStatus.ACCEPTED);
	}

	@PostMapping(value = "/{hospital_id}")
	public ResponseEntity<Doctor> saveDoctor(@Valid @RequestBody Doctor doctor,
			@PathVariable("hospital_id") String hospital_id) {
		return new ResponseEntity<Doctor>(doctorService.saveDoctorWithHospital(doctor, hospital_id),
				HttpStatus.ACCEPTED);
	}

	@GetMapping(value = "/{doctor_id}")
	public ResponseEntity<Doctor> getDoctorById(@PathVariable("doctor_id") String doctor_id) {
		return new ResponseEntity<Doctor>(doctorService.getDoctorById(doctor_id), HttpStatus.ACCEPTED);
	}

	@GetMapping(value = "/by_department/{doctor_department}")
	public ResponseEntity<List<Doctor>> getDoctorByDepartmentPattern(
			@PathVariable("doctor_department") String doctor_department) {
		return new ResponseEntity<List<Doctor>>(doctorService.getDoctorByDepartmentPattern(doctor_department),
				HttpStatus.ACCEPTED);
	}
	...
	public ResponseEntity<List<Doctor>> getDoctorByNamePattern(@PathVariable("doctor_name") String doctor_name) {
		return new ResponseEntity<List<Doctor>>(doctorService.getDoctorByNamePattern(doctor_name), HttpStatus.ACCEPTED);
	}

	@GetMapping(value = "/by_hospital/{hospital_id}")
	public ResponseEntity<List<Doctor>> getDoctorByHospitalId(@PathVariable("hospital_id") String hospital_id) {
		return new ResponseEntity<List<Doctor>>(doctorService.getDoctorByNamePattern(hospital_id), HttpStatus.ACCEPTED);
	}

	@GetMapping()
	public ResponseEntity<List<Doctor>> getAllDoctors() {
		return new ResponseEntity<List<Doctor>>(doctorService.getAllDoctors(), HttpStatus.ACCEPTED);
	}

	@PutMapping("/{doctor_id}")
	public ResponseEntity<Doctor> updateDoctor(@PathVariable("doctor_id") String doctor_id,
			@RequestBody Doctor doctor) {
		return new ResponseEntity<Doctor>(doctorService.updateDoctor(doctor_id, doctor), HttpStatus.ACCEPTED);
	}
	...
	public ResponseEntity<Doctor> updateDoctorHospital(@PathVariable("doctor_id") String doctor_id,
			@PathVariable("hospital_id") String hospital_id) {
		return new ResponseEntity<Doctor>(doctorService.updateDoctorHospital(doctor_id, hospital_id),
				HttpStatus.ACCEPTED);
	}

	@DeleteMapping(value = "/{doctor_id}")
	public ResponseEntity<String> deleteDoctorById(@PathVariable("doctor_id") String doctor_id) {
		return new ResponseEntity<String>(doctorService.deleteDoctorById(doctor_id), HttpStatus.ACCEPTED);
	}
